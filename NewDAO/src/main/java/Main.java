...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        Bank account = new mysqlConnector();
        do{
            System.out.println("**************************************");
            ...
            switch(str) {
                ...
                case 'D':
                    ...
                    String NameToDelete = dinput.nextLine();
                    account.deleteUsers(NameToDelete);
                    break;
                ...
                case 'a':
                    ...
                    int AccountNumber = random.nextInt(7);
                    BankAccount neAccount = new BankAccount(NewName, AccountNumber, newBalance, NewPhone, NewEmail);
                    account.Addaccount(neAccount);
                    break;
